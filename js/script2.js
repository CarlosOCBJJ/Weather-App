function getUV(lat,lon){
  var uvQueryURL = `https://api.openweathermap.org/data/2.5/uvi?appid=2b88addf105fbcb3d6a6266a96195eef&lat=${lat}&lon=${lon}`;
    $.ajax({
    url: uvQueryURL,
    method: "GET"
...
$("#run-search").on("click", function (event) {
  ...
  var queryURL = `https://api.openweathermap.org/data/2.5/weather?q=${searchCity}&appid=2b88addf105fbcb3d6a6266a96195eef`;
  ...
  $.ajax({
    ...
    var queryFiveDayURL = `https://api.openweathermap.org/data/2.5/forecast?q=${searchCity}&appid=2b88addf105fbcb3d6a6266a96195eef`;
    $.ajax({
      url: queryFiveDayURL,
      method: "GET"
